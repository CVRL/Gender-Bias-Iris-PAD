...
### Table of contents
* [Abstract](#abstract)
* [Datasets for Gender Bias Evaluation in Iris PAD](#dataset)
* [Citation](#citation)
...
<a name="dataset"/></a>
### Datasets for Gender Bias Evaluation in Iris PAD

CSV files containing train and test sets used for training and evaluation the models for each experiment (E1, E3, and E4) can be found at [CSVs](https://github.com/CVRL/Gender-Bias-Iris-PAD/tree/main/CSVs).

Instructions on how to request a copy of each dataset can be found at [CVRL webpage](https://cvrl.nd.edu/projects/data/).
